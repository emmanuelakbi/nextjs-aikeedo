...
export default function EarningsReport({ data }: EarningsReportProps) {
  ...
  const maxAmount = Math.max(...data.earningsByMonth.map((m: any) => m.amount), 1);

  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Earnings Report</h2>
      ...
      <div className="mb-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-gray-600 mb-1">Total Earnings (Period)</p>
