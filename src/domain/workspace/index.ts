...
export type { WorkspaceProps, CreateWorkspaceProps } from './entities/Workspace';

// Repository Interface
export { IWorkspaceRepository, WorkspaceMemberRole } from './repositories/IWorkspaceRepository';
